    ...
    <section>
      ...
      <div className="settings-layout">
        ...
        <div className="settings-panel glass-panel">
          <div className="settings-section"><div><Power size={19} /><span><strong>{t(isMac ? "macOS startup" : "Windows startup")}</strong><small>{t(isMac ? "Start quietly in the menu bar after sign-in." : "Start quietly in the system tray after sign-in.")}</small></span></div><label className="switch"><input type="checkbox" checked={draft.launchAtStartup} onChange={(event) => update("launchAtStartup", event.target.checked)} /><span /></label></div>
